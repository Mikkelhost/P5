...
void ISR1_SetVector(cyisraddress address)
{
    ...
    ramVectorTable[CYINT_IRQ_BASE + (uint32)ISR1__INTC_NUMBER] = address;
}
...
cyisraddress ISR1_GetVector(void)
{
    ...
    return ramVectorTable[CYINT_IRQ_BASE + (uint32)ISR1__INTC_NUMBER];
}
